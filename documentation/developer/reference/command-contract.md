...
| `make verify-migrations` | Creates fresh authoritative and reconstructible databases through their independent v1 migrations and verifies Gate 0 metadata. |
...
| `make verify-release` | Repeats change and UI gates, then refuses success unless passing Gate 0 physical-device evidence exists. Passing this gate still does not approve owner data. |
