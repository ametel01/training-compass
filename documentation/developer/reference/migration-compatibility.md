...
| --- | --- | --- | --- |
| `authoritative.sqlite` | 8 | Gate 0 v7 database or empty database; earlier Gate 0 versions migrate through the retained chain | `make verify-migrations` |
