...
| --- | --- | --- | --- |
| `authoritative.sqlite` | 16 | Every prefix v1–v16, an interrupted migration, or an empty database | `make verify-migrations` |
...
| --- | --- | --- |
| Authoritative v1–v16 | `authoritative_v1_gate_zero` through `authoritative_v16_health_workout_write_back` | v16 |
