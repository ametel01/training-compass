...
| --- | --- | --- | --- |
| `authoritative.sqlite` | 10 | Gate 0 v9 database or empty database; earlier Gate 0 versions migrate through the retained chain | `make verify-migrations` |
