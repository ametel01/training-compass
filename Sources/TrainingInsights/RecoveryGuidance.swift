...
public enum RecoveryGuidanceSuppressionReason: String, Codable, Equatable, Sendable {
    ...
    public static var insufficientFamilies: Self {
        .notEnoughEstablishedFamilies
    }

    public static var unavailableCurrentEvidence: Self {
        .familyObservationUnavailable
    }
}
...
public struct RecoveryGuidanceMeasurement: Codable, Equatable, Identifiable, Sendable {
    ...
    public init(
        ...
        self.metric = metric
        family = RecoveryEvidenceFamily(metric: metric)
        self.date = date
        self.value = value
        unit = metric.unit
...
public struct RecoveryGuidance: Codable, Equatable, Sendable {
    ...
    public init(
        ...
        isAvailable = enabled && isEligible
    ...
    public var canShowPrompt: Bool {
        isAvailable && prompt != nil
    }
...
public struct RecoveryGuidanceCalculator: Sendable {
    ...
    public func calculate(
        ...
        let explanation = InsightExplanation(
            ...
            includedDates: measurements.map(\.date.iso8601String),
