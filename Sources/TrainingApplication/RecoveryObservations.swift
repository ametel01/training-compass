...
public enum HealthRecoveryObservationMetric: String, Codable, CaseIterable, Equatable, Sendable {
    ...
    public static var heartRateVariability: Self {
...
public extension HealthRecoverySampleProvenance {
...
public struct HealthRecoveryDailyObservation: Codable, Equatable, Identifiable, Sendable {
    ...
    public var latestIncludedSampleID: String {
        latestIncludedSample.id
    }

    public var latestIncludedSampleDate: Date {
        latestIncludedSample.date
    }

    public var latestAlgorithmVersion: String? {
        algorithmVersions.last
    }

    public var sourceIsComparable: Bool {
        source.isComparable
    }
}
...
public struct HealthRecoveryObservationProjection: Codable, Equatable, Sendable {
    ...
    public var isEmpty: Bool {
        restingHeartRate.isEmpty && heartRateVariability.isEmpty
    }
}
...
public struct HealthRecoveryObservationCalculator: Sendable {
    ...
    public func calculate(
        ...
        let dates = Array(Set(allIncluded.map(\.date.iso8601String))).sorted()
...
public extension HealthRecoveryEvidenceSnapshot {
