...
public struct NoOpTrainingErasurePhaseObserver: TrainingErasurePhaseObserver {
    public init() {}
    public func didReach(_: TrainingErasurePhase) throws {}
}
...
public enum TrainingErasureError: Error, Equatable, Sendable {
    ...
    public var privacySafeDescription: String {
        switch self {
        case .confirmationRequired: "Erasing app data requires explicit confirmation."
        case .unavailable: "Full app erasure is unavailable."
        case .cleanupFailed: "Some local app data could not be removed safely."
        }
    }
}
