...
public struct HealthRecoverySampleProvenance: Codable, Equatable, Sendable {
  ...
  public var source: HealthRecoverySampleProvenance { self }
  public var algorithm: String? { algorithmVersion }
}
...
public struct HealthSleepSample: Codable, Equatable, Sendable, Identifiable {
  ...
  public var time: Date { startDate }
  public var sample: TimeInterval { duration }
  public var sleepStage: HealthSleepStage { stage }
}
...
public struct HealthRestingHeartRateSample: Codable, Equatable, Sendable, Identifiable {
  ...
  public var sample: Double { beatsPerMinute }
  public var value: Double { beatsPerMinute }
...
public struct HealthHRVSDNNSample: Codable, Equatable, Sendable, Identifiable {
  ...
  public var sample: Double { milliseconds }
  public var value: Double { milliseconds }
  public var time: Date { date }
}
...
public enum HealthRecoverySample: Codable, Equatable, Sendable, Identifiable {
  ...
  public var id: String {
    switch self {
    case .sleep(let sample): sample.id
    case .restingHeartRate(let sample): sample.id
    case .heartRateVariability(let sample): sample.id
    }
  }
  ...
  public var date: Date {
    switch self {
    case .sleep(let sample): sample.startDate
    case .restingHeartRate(let sample): sample.date
    case .heartRateVariability(let sample): sample.date
    }
  }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    case .restingHeartRate(let value):
      try container.encode(Kind.restingHeartRate, forKey: .kind)
      try container.encode(value, forKey: .value)
    case .heartRateVariability(let value):
  ...
  public init(from decoder: Decoder) throws {
    ...
    case .sleep: self = .sleep(try container.decode(HealthSleepSample.self, forKey: .value))
    case .restingHeartRate:
      self = .restingHeartRate(
        try container.decode(HealthRestingHeartRateSample.self, forKey: .value))
    case .heartRateVariability:
      self = .heartRateVariability(
        try container.decode(HealthHRVSDNNSample.self, forKey: .value))
    }
  }
}
...
public struct HealthRecoveryEvidenceSnapshot: Codable, Equatable, Sendable {
  ...
  public var streamStatuses: [HealthStreamStatus] { statuses }
}
