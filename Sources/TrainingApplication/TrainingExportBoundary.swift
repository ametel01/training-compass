...
public enum TrainingExportJSONValue: Codable, Equatable, Sendable {
  ...
  public init(from decoder: Decoder) throws {
    ...
    case .blob:
      self = .blob(base64: try container.decode(String.self, forKey: .value))
    }
  }
...
public struct TrainingAuthoritativeExportData: Codable, Equatable, Sendable {
  ...
  public var recordCount: Int { tables.reduce(0) { $0 + $1.records.count } }
...
public enum TrainingExportError: Error, Equatable, Sendable {
  ...
  public var privacySafeDescription: String {
    switch self {
    case .unavailable: return "Export is unavailable."
    case .confirmationRequired: return "Export confirmation is required."
    case .integrityMismatch: return "The export integrity check failed."
    case .unsupportedSchema: return "This export schema is not supported."
    case .insufficientSpace: return "There is not enough temporary storage for this export."
    case .cleanupFailed: return "The temporary export could not be cleaned up."
    }
  }
}
...
extension TrainingAuthoritativeExportRepository {
