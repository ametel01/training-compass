...
public struct TrainingCycleSession: Codable, Equatable, Hashable, Identifiable, Sendable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        try self.init(
            ...
            intendedDate: container.decode(TrainingDate.self, forKey: .intendedDate),
            sourceTemplateSessionID: container.decode(String.self, forKey: .sourceTemplateSessionID),
            primaryLiftID: container.decode(String.self, forKey: .primaryLiftID),
            assistanceLiftID: container.decode(String.self, forKey: .assistanceLiftID),
            prescriptions: container.decodeIfPresent(
                [TrainingSetPrescription].self, forKey: .prescriptions,
            ) ?? [],
            status: container.decodeIfPresent(TrainingSessionStatus.self, forKey: .status)
                ?? .scheduled,
        )
    }

    public var primaryLiftRole: String {
        primaryLiftID
    }

    public var assistanceLiftRole: String {
        assistanceLiftID
    }
}
...
public struct TrainingCycleSnapshot: Codable, Equatable, Sendable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        try self.init(
            id: container.decode(String.self, forKey: .id),
            week1AnchorDate: container.decode(TrainingDate.self, forKey: .week1AnchorDate),
            weeks: container.decode([TrainingWeek].self, forKey: .weeks),
            sourceTemplate: container.decode(ScheduleTemplateSnapshot.self, forKey: .sourceTemplate),
            includesProvisionalDeload: container.decode(
                Bool.self, forKey: .includesProvisionalDeload,
            ),
            lifecycleState: container.decode(
            ...
            liftSnapshots: container.decodeIfPresent(
...
public struct TrainingCycle: Codable, Equatable, Identifiable, Sendable {
    ...
    public var trainingWeeks: [TrainingWeek] {
        weeks
    }
    ...
    public var trainingMaxSnapshots: [String: LiftConfigurationSnapshot] {
        liftSnapshots
    }
}
