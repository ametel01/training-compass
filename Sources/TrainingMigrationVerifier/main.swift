...
guard
  ...
  throw MigrationVerificationError.gateZeroMarkerMissing(store: "authoritative v10")
}
...
print(
  "Authoritative v10 and reconstructible v1 migration interruption, retry, and idempotence passed.")
