...
final class PreDataHealthKitAdapterTests: XCTestCase {
    ...
    func testPagedOversizedRouteIsSimplifiedWithinRetentionMemoryAndTimeBounds() {
        let total = 50000
        ...
        for _ in 0 ..< 10 {
            var simplifier = BoundedHealthKitRouteSimplifier(maximumRetainedPoints: 2000)
        ...
        XCTAssertLessThanOrEqual(peakBufferedPointCount, 4001)
