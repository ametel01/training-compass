...
final class RecoveryObservationsTests: XCTestCase {
    ...
    func testStaleFailureCoverageAndAlgorithmContextRemainVisibleAndNeutral() throws {
        ...
        let observation = try XCTUnwrap(HealthRecoveryObservationCalculator().calculate(
            restingHeartRate: [],
            heartRateVariability: [
