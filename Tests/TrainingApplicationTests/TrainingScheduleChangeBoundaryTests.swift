...
private actor ScheduleChangeRepository: TrainingRepository {
    ...
    func discardDraftTrainingCycle(
        expectedBefore _: TrainingCycleSnapshot, auditID _: String,
        occurredAt _: Int64,
    ) async throws -> TrainingCycleAuditEntry {
        fatalError()
    }
    ...
    func saveLiftConfiguration(
        _: LiftConfiguration, expectedBefore _: LiftConfigurationSnapshot?, auditID _: String,
        occurredAt _: Int64, action _: LiftConfigurationAuditAction,
