...
final class TrainingInsightsModuleTests: XCTestCase {
    ...
    private func result(
        ...
        try RecordedSetResult(
            id: id,
            sessionID: "session",
            prescriptionID: prescriptionID,
            result: SetResult(weight: SetResultWeight(kg: weightKg), repetitions: repetitions),
            recordedAt: 1,
        )
    }
}
